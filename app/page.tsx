        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { name: "Fiona",     role: "Product Owner",  image: "/Fiona.jpg" },
              ...
              <div className="flex flex-col gap-5 flex-1">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://www.linkedin.com/company/syncycleapp/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/20 hover:border-white/40 transition-colors duration-300 flex items-center justify-center text-white/55 hover:text-white" aria-label="LinkedIn">
                    ...
                    <a href="https://www.instagram.com/syncycle.app/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/20 hover:border-white/40 transition-colors duration-300 flex items-center justify-center text-white/55 hover:text-white" aria-label="Instagram">
                    ...
                    <a href="https://www.tiktok.com/@syncycle.app" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/20 hover:border-white/40 transition-colors duration-300 flex items-center justify-center text-white/55 hover:text-white" aria-label="TikTok">
